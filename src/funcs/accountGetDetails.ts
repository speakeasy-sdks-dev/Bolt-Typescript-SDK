 ...
 */
export async function accountGetDetails(
  ...
  Result<
    operations.AccountGetResponse,
    | errors.AccountGetResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AccountGetResponse$inboundSchema, {
      key: "account",
    }),
    M.jsonErr("4XX", errors.AccountGetResponseBody$inboundSchema),
    M.fail("5XX"),
    M.nil("default", operations.AccountGetResponse$inboundSchema),
