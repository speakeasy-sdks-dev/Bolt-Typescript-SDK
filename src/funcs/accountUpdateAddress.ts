 ...
 */
export async function accountUpdateAddress(
  ...
  Result<
    ...
    | errors.AccountAddressEditResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AccountAddressEditResponse$inboundSchema, {
      key: "address-listing",
    }),
    M.jsonErr("4XX", errors.AccountAddressEditResponseBody$inboundSchema),
    M.fail("5XX"),
    M.nil("default", operations.AccountAddressEditResponse$inboundSchema),
