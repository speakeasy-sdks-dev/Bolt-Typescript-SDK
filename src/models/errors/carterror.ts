...
/** @internal */
export const SchemasCartErrorTag$inboundSchema: z.ZodNativeEnum<
  typeof SchemasCartErrorTag
> = z.nativeEnum(SchemasCartErrorTag);

/** @internal */
export const SchemasCartErrorTag$outboundSchema: z.ZodNativeEnum<
  typeof SchemasCartErrorTag
...
/** @internal */
export const CartError$inboundSchema: z.ZodType<
  CartError,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const CartError$outboundSchema: z.ZodType<
  CartError$Outbound,
  z.ZodTypeDef,
  CartError
> = z.instanceof(CartError)
  .transform(v => v.data$)
  .pipe(
    z.object({
